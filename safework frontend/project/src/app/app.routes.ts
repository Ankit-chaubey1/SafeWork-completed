...
export const routes: Routes = [
  ...
  },
  {
    ...
    canActivate: [guestGuard],
    loadComponent: () => import('./features/auth/employee-register/employee-register.component').then(m => m.EmployeeRegisterComponent),
  },
  {
    path: '',
    ...
    children: [
      ...
      { path: 'employees', loadComponent: () => import('./features/employees/EmployeeListComponent/employee-list.component').then(m => m.EmployeeListComponent) },
      { path: 'employee-verification', loadComponent: () => import('./features/employees/EmployeeVerificationComponent/employee-verification.component').then(m => m.EmployeeVerificationComponent) },
